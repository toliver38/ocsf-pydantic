...
class ProcessRemediationActivity(RemediationActivity):
    """
    Process Remediation Activity events report on attempts at remediating processes.
    """

    class_uid: int = 7003 # The unique identifier of a class.
    class_name: str = 'Process Remediation Activity' # The event class name.
    ...
    process: Process # The process that pertains to the remediation event.
