...
class NetworkRemediationActivity(RemediationActivity):
    ...
    class_uid: int = 7004 # The unique identifier of a class.
    class_name: str = 'Network Remediation Activity' # The event class name.
    ...
    connection_info: NetworkConnectionInformation # The network connection that pertains to the remediation event.
