...
class RegistryValueQuery(Discovery):
    """
    Registry Value Query events report information about discovered Windows registry values.
    """

    class_uid: int = 205005 # The unique identifier of a class.
    class_name: str = 'Registry Value Query' # The event class name.
    ...
    reg_value: RegistryValue # The registry value that pertains to the event.
