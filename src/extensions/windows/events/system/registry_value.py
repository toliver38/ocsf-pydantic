...
from extensions.windows.objects.registry_value import RegistryValue
...
class RegistryValueActivity(SystemActivity):
    """
    Registry Value Activity events report when a process performs an action on a Windows registry value.
    """

    class_uid: int = 201002 # The unique identifier of a class.
    class_name: str = 'Registry Value Activity' # The event class name.
    ...
    actor: Actor # The actor that performed the activity on the reg_value object.
    ...
    reg_value: RegistryValue # Describes details about the registry value that triggered the detection.
    ...
    prev_reg_value: Optional[RegistryValue] = None # The registry value before the mutation.
