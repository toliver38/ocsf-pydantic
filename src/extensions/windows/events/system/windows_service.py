...
from extensions.windows.objects.windows_service import WindowsService
...
class WindowsServiceActivity(SystemActivity):
    """
    Windows Service Activity events report when a process interacts with the Service Control Manager.
    """

    class_uid: int = 201004 # The unique identifier of a class.
    class_name: str = 'Windows Service Activity' # The event class name.
    ...
    win_service: WindowsService # Describes details about the Windows service that triggered the detection.
